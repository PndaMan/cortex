<script lang="ts">
  ...
  const CATEGORIES: { id: string; label: string; emojis: string[] }[] = [
    { id: "study", label: t("Study"), emojis: ["📚","📖","📝","📐","📏","🖊️","✏️","🖍️","🖌️","🔖","🏷️","📌","📍","📎","🖇️","🗂️","📑","📋","📓","📔","📒","📕","📗","📘","📙","🔭","🧮","💡","🧠","🧩","🔍","🔎","🎯","🗒️","📰","🗞️","🗃️","📁","📂","🗄️","✒️","🎓","🧑‍🎓"] },
    { id: "science", label: t("Science"), emojis: ["🔬","🧪","⚗️","🧫","⚛️","🧬","🦠","🌡️","🔋","🔌","🧲","🛰️","🚀","🪐","🌍","🌌","💊","💉","🩺","🦴","🫀","🧠","🩸","🌠","☄️","⚖️","🧴","🧯","🪫","🔭"] },
    { id: "tech", label: t("Tech"), emojis: ["💻","🖥️","⌨️","🖱️","🖲️","🕹️","🎮","🖨️","📱","📲","☎️","📞","📟","📠","💾","💿","📀","📡","🛜","🌐","🔗","⚡","🔌","🔋","🤖","👾","🧑‍💻","🛠️","⚙️","💡"] },
    { id: "math", label: t("Math"), emojis: ["➕","➖","✖️","➗","🟰","♾️","∑","√","π","∫","∞","%","‰","°","∠","∂","∇","≈","≠","≤","≥","±","÷","µ","θ","Δ","Σ","Ω","ƒ","№"] },
    { id: "arts", label: t("Arts"), emojis: ["🎨","🖌️","🖍️","🖼️","🎵","🎶","🎼","🎹","🎸","🎻","🥁","🎷","🎺","🪕","🪗","🎬","🎭","📷","📸","🎙️","🎤","🎧","💃","🕺","🩰","🎟️","🎫"] },
    { id: "symbols", label: t("Symbols"), emojis: ["◆","◇","●","○","▲","△","■","□","★","☆","✦","✧","❖","✺","❂","⬡","⬢","♦","♠","♣","♥","♢","♤","♧","♡","⚜️","🔰","✚","∞","§","¶","†","‡","※","✱","❉"] },
    { id: "objects", label: t("Objects"), emojis: ["⚙️","🔧","🔨","🛠️","⛏️","🧰","🗜️","🔩","⚖️","🔑","🗝️","🧭","⏳","⌛","⏰","🕰️","🔒","🔓","🔐","💼","📦","🎁","🧷","📡","🛡️","⚔️","🗡️","🏹","💰","💎","🏆","🥇","🔔","🔦","🪙"] },
    { id: "nature", label: t("Nature"), emojis: ["🌟","⭐","✨","🔥","💧","💦","❄️","☃️","🌊","🌋","⛰️","🏔️","🌙","🌛","☀️","🌤️","⛅","🌧️","⛈️","🌩️","⚡","🌈","🍀","☘️","🌸","🌺","🌻","🌼","🌷","🌹","🍂","🍃","🌿","🌳","🌲","🌴","🌱","🌵","🍁","🪨"] },
    { id: "animals", label: t("Animals"), emojis: ["🐶","🐱","🦊","🐻","🐼","🐨","🐯","🦁","🐮","🐷","🐸","🐵","🐔","🐧","🐦","🦅","🦉","🦄","🐝","🐞","🦋","🐢","🐍","🐙","🦑","🦕","🦖","🐬","🐳","🐠","🦓","🦒","🐘","🦦"] },
    { id: "food", label: t("Food"), emojis: ["🍎","🍏","🍊","🍋","🍌","🍉","🍇","🍓","🫐","🍒","🍑","🥭","🍍","🥥","🥝","🍅","🥑","🌽","🥕","🥦","🍞","🥐","🧀","🥚","🍕","🍔","🌮","🌯","🍣","🍙","🍜","🍩","🍪","🎂","☕","🍵","🧋"] },
    { id: "activity", label: t("Activity"), emojis: ["⚽","🏀","🏈","⚾","🥎","🎾","🏐","🏉","🥏","🎱","🏓","🏸","🥅","⛳","🏹","🎣","🥊","🥋","🎽","⛸️","🎿","⛷️","🏂","🏋️","🤸","🤺","🏌️","🏇","🚴","🧗","🏄","🏊","🎮","🎲","♟️","🎯","🏆"] },
    { id: "places", label: t("Places"), emojis: ["🌐","🗺️","🧭","🧳","🏛️","🏺","🗿","🏰","🏯","🗼","🗽","⛩️","🕌","🛕","⛪","🏟️","🏝️","🏔️","🗻","🌋","🏕️","🏖️","🌍","🌎","🌏","🧱","🏠","🏢","🏥","🏦","🏨"] },
    { id: "faces", label: t("Faces"), emojis: ["🙂","😀","😃","😄","😁","😎","🤓","🧐","🤔","🤨","😴","🥳","😇","🤩","😏","🙃","😌","😅","🤖","👻","👋","🙌","👏","🙏","💪","🧑‍🎓","🧑‍🏫","🧑‍🔬","🧑‍💻","💬","🗨️","🗣️","👁️","🫡"] },
  ];
