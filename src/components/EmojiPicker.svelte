<script lang="ts">
  ...
  const CATEGORIES: { id: string; label: string; emojis: string[] }[] = [
    { id: "study", label: "Study", emojis: ["📚","📖","📝","📐","📏","🖊️","✏️","🖍️","🖌️","🔖","🏷️","📌","📍","📎","🖇️","🗂️","📑","📋","📓","📔","📒","📕","📗","📘","📙","🔭","🧮","💡","🧠","🧩","🔍","🔎","🎯","🗒️","📰","🗞️","🗃️","📁","📂","🗄️","✒️","🎓","🧑‍🎓"] },
    { id: "science", label: "Science", emojis: ["🔬","🧪","⚗️","🧫","⚛️","🧬","🦠","🌡️","🔋","🔌","🧲","🛰️","🚀","🪐","🌍","🌌","💊","💉","🩺","🦴","🫀","🧠","🩸","🌠","☄️","⚖️","🧴","🧯","🪫","🔭"] },
    { id: "tech", label: "Tech", emojis: ["💻","🖥️","⌨️","🖱️","🖲️","🕹️","🎮","🖨️","📱","📲","☎️","📞","📟","📠","💾","💿","📀","📡","🛜","🌐","🔗","⚡","🔌","🔋","🤖","👾","🧑‍💻","🛠️","⚙️","💡"] },
    { id: "math", label: "Math", emojis: ["➕","➖","✖️","➗","🟰","♾️","∑","√","π","∫","∞","%","‰","°","∠","∂","∇","≈","≠","≤","≥","±","÷","µ","θ","Δ","Σ","Ω","ƒ","№"] },
    { id: "arts", label: "Arts", emojis: ["🎨","🖌️","🖍️","🖼️","🎵","🎶","🎼","🎹","🎸","🎻","🥁","🎷","🎺","🪕","🪗","🎬","🎭","📷","📸","🎙️","🎤","🎧","💃","🕺","🩰","🎟️","🎫"] },
    { id: "symbols", label: "Symbols", emojis: ["◆","◇","●","○","▲","△","■","□","★","☆","✦","✧","❖","✺","❂","⬡","⬢","♦","♠","♣","♥","♢","♤","♧","♡","⚜️","🔰","✚","∞","§","¶","†","‡","※","✱","❉"] },
    { id: "objects", label: "Objects", emojis: ["⚙️","🔧","🔨","🛠️","⛏️","🧰","🗜️","🔩","⚖️","🔑","🗝️","🧭","⏳","⌛","⏰","🕰️","🔒","🔓","🔐","💼","📦","🎁","🧷","📡","🛡️","⚔️","🗡️","🏹","💰","💎","🏆","🥇","🔔","🔦","🪙"] },
    { id: "nature", label: "Nature", emojis: ["🌟","⭐","✨","🔥","💧","💦","❄️","☃️","🌊","🌋","⛰️","🏔️","🌙","🌛","☀️","🌤️","⛅","🌧️","⛈️","🌩️","⚡","🌈","🍀","☘️","🌸","🌺","🌻","🌼","🌷","🌹","🍂","🍃","🌿","🌳","🌲","🌴","🌱","🌵","🍁","🪨"] },
    { id: "animals", label: "Animals", emojis: ["🐶","🐱","🦊","🐻","🐼","🐨","🐯","🦁","🐮","🐷","🐸","🐵","🐔","🐧","🐦","🦅","🦉","🦄","🐝","🐞","🦋","🐢","🐍","🐙","🦑","🦕","🦖","🐬","🐳","🐠","🦓","🦒","🐘","🦦"] },
    { id: "food", label: "Food", emojis: ["🍎","🍏","🍊","🍋","🍌","🍉","🍇","🍓","🫐","🍒","🍑","🥭","🍍","🥥","🥝","🍅","🥑","🌽","🥕","🥦","🍞","🥐","🧀","🥚","🍕","🍔","🌮","🌯","🍣","🍙","🍜","🍩","🍪","🎂","☕","🍵","🧋"] },
    { id: "activity", label: "Activity", emojis: ["⚽","🏀","🏈","⚾","🥎","🎾","🏐","🏉","🥏","🎱","🏓","🏸","🥅","⛳","🏹","🎣","🥊","🥋","🎽","⛸️","🎿","⛷️","🏂","🏋️","🤸","🤺","🏌️","🏇","🚴","🧗","🏄","🏊","🎮","🎲","♟️","🎯","🏆"] },
    { id: "places", label: "Places", emojis: ["🌐","🗺️","🧭","🧳","🏛️","🏺","🗿","🏰","🏯","🗼","🗽","⛩️","🕌","🛕","⛪","🏟️","🏝️","🏔️","🗻","🌋","🏕️","🏖️","🌍","🌎","🌏","🧱","🏠","🏢","🏥","🏦","🏨"] },
    { id: "faces", label: "Faces", emojis: ["🙂","😀","😃","😄","😁","😎","🤓","🧐","🤔","🤨","😴","🥳","😇","🤩","😏","🙃","😌","😅","🤖","👻","👋","🙌","👏","🙏","💪","🧑‍🎓","🧑‍🏫","🧑‍🔬","🧑‍💻","💬","🗨️","🗣️","👁️","🫡"] },
  ];
